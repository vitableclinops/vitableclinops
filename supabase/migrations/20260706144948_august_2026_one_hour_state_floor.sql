...
begin
  ...
  with august_inputs(state, target_hours, target_slots, inactive) as (
    values
      ('PA', 809::numeric, 1618::integer, false),
      ...
      ('WY',   1::numeric,    2::integer, false),
      ('OK',   1::numeric,    2::integer, false),
      ('NE',   1::numeric,    2::integer, false)
  ),
  targets as (
    select
      i.state,
  ...
  select
    ...
    daily_target_hours,
    null,
    'august_2026_2250_state_targets_v3',
    1.0,
    1.0,
    v_run_id,
    v_computed_at,
