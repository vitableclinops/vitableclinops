...
export const states: State[] = [
  ...
  // Additional states with full regulatory intelligence
  {
    id: 'ak',
    name: 'Alaska',
    abbreviation: 'AK',
    demandTag: 'stable',
    hasFPA: true,
    fpaEligibilityCriteria: ['No supervision requirements'],
    fpaApplicationRequired: false,
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state. APRNs practice independently. Part of NLC.',
    specialConsiderations: ['Remote area practice considerations', 'Telemedicine-friendly regulations'],
    applicationFeeRange: { min: 200, max: 300 },
    processingTimeWeeks: { min: 4, max: 8 },
    lastUpdated: new Date('2024-01-15'),
  },
  {
    ...
    abbreviation: 'CT',
    demandTag: 'watch',
    demandNotes: 'Hartford and New Haven market evaluation',
    hasFPA: true,
    fpaEligibilityCriteria: ['No transition period required'],
    fpaApplicationRequired: false,
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state since 2014. APRNs may prescribe including controlled substances.',
    applicationFeeRange: { min: 200, max: 250 },
    processingTimeWeeks: { min: 6, max: 10 },
    lastUpdated: new Date('2024-01-12'),
  },
  {
    ...
    abbreviation: 'DC',
    demandTag: 'watch',
    demandNotes: 'Federal employee market considerations',
    hasFPA: true,
    fpaEligibilityCriteria: ['No hour requirements'],
    fpaApplicationRequired: false,
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority. NPs practice independently without physician oversight.',
    applicationFeeRange: { min: 166, max: 220 },
    processingTimeWeeks: { min: 4, max: 8 },
    lastUpdated: new Date('2024-01-10'),
  },
  {
    ...
    demandTag: 'stable',
    hasFPA: true,
    fpaEligibilityCriteria: ['2 years or 4,000 hours of collaboration required first'],
    fpaApplicationRequired: true,
    requiresCollaborativeAgreement: true,
    collaborativeAgreementRequirements: {
      meetingCadence: 'quarterly',
      chartReviewRequired: false,
      supervisoryActivities: ['Collaboration during transition period'],
    },
    requiresPrescriptiveAuthority: false,
    notes: 'Independent practice after completing 4,000 hours of collaborative practice. Joint Practice Committee oversees transition.',
    specialConsiderations: ['Transition period before FPA'],
    applicationFeeRange: { min: 141, max: 200 },
    processingTimeWeeks: { min: 6, max: 10 },
    lastUpdated: new Date('2024-01-08'),
  },
  {
    ...
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state. Global signature authority for prescriptions. Not part of NLC.',
    specialConsiderations: ['Not part of Nurse Licensure Compact', 'Island-specific practice considerations'],
    applicationFeeRange: { min: 160, max: 220 },
    processingTimeWeeks: { min: 6, max: 12 },
    lastUpdated: new Date('2024-01-05'),
  },
  {
    ...
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state. Part of NLC. Streamlined licensing process.',
    applicationFeeRange: { min: 119, max: 175 },
    processingTimeWeeks: { min: 4, max: 6 },
    lastUpdated: new Date('2024-01-03'),
  },
  {
    ...
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state. Part of NLC. Board of Nursing processes applications.',
    applicationFeeRange: { min: 110, max: 160 },
    processingTimeWeeks: { min: 4, max: 8 },
    lastUpdated: new Date('2024-01-02'),
  },
  {
    ...
    collaborativeAgreementRequirements: {
      meetingCadence: 'quarterly',
      chartReviewRequired: true,
      chartReviewFrequency: 'As defined in collaborative agreement',
      supervisoryActivities: ['Physician oversight', 'Chart review', 'Protocol adherence'],
    },
    requiresPrescriptiveAuthority: true,
    prescriptiveAuthorityNotes: 'Prescriptive authority application separate. Must have collaborative agreement in place.',
    notes: 'Collaborative practice agreement required. Physician must be within 150 miles for consultation. Part of NLC.',
    scopeLimitations: ['Geographic proximity requirement for collaborating physician'],
    applicationFeeRange: { min: 125, max: 175 },
    processingTimeWeeks: { min: 4, max: 8 },
    lastUpdated: new Date('2024-01-10'),
  },
  {
    ...
    abbreviation: 'LA',
    demandTag: 'watch',
    demandNotes: 'New Orleans and Baton Rouge markets',
    hasFPA: false,
    fpaApplicationRequired: false,
    requiresCollaborativeAgreement: true,
    collaborativeAgreementRequirements: {
      meetingCadence: 'quarterly',
      chartReviewRequired: true,
      chartReviewFrequency: 'Periodic chart review required',
      supervisoryActivities: ['Collaborative practice agreement', 'Chart review', 'Consultation'],
    },
    requiresPrescriptiveAuthority: true,
    prescriptiveAuthorityNotes: 'DEA registration required for controlled substances. Collaborative agreement must specify prescribing protocols.',
    notes: 'Collaborative practice agreement required. Board of Nursing oversees APRN practice. Part of NLC.',
    applicationFeeRange: { min: 100, max: 175 },
    processingTimeWeeks: { min: 6, max: 10 },
    lastUpdated: new Date('2024-01-08'),
  },
  {
    ...
    abbreviation: 'MA',
    demandTag: 'watch',
    demandNotes: 'Boston metro market evaluation',
    hasFPA: true,
    fpaEligibilityCriteria: ['2 years of supervised practice', 'Transition to independent practice after requirements met'],
    fpaApplicationRequired: true,
    requiresCollaborativeAgreement: true,
    collaborativeAgreementRequirements: {
      meetingCadence: 'quarterly',
      chartReviewRequired: false,
      supervisoryActivities: ['Supervisory arrangement during transition period'],
    },
    requiresPrescriptiveAuthority: false,
    notes: 'FPA available after completing 2 years of supervised practice. Initial supervision required. Not part of NLC.',
    specialConsiderations: ['Not part of Nurse Licensure Compact', 'Transition period supervision'],
    applicationFeeRange: { min: 275, max: 350 },
    processingTimeWeeks: { min: 8, max: 14 },
    lastUpdated: new Date('2024-01-12'),
  },
  {
    ...
    abbreviation: 'MD',
    demandTag: 'watch',
    demandNotes: 'Baltimore and DC suburbs markets',
    hasFPA: true,
    fpaEligibilityCriteria: ['18 months of attested practice with physician'],
    fpaApplicationRequired: true,
    requiresCollaborativeAgreement: true,
    collaborativeAgreementRequirements: {
      meetingCadence: 'quarterly',
      chartReviewRequired: false,
      supervisoryActivities: ['Attestation during transition period'],
    },
    requiresPrescriptiveAuthority: false,
    notes: 'Independent practice after 18 months attested practice. Attestation form required from collaborating physician. Part of NLC.',
    specialConsiderations: ['Attestation requirement for FPA'],
    applicationFeeRange: { min: 100, max: 175 },
    processingTimeWeeks: { min: 6, max: 10 },
    lastUpdated: new Date('2024-01-10'),
  },
  {
    ...
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state. Early adopter of FPA. Part of NLC.',
    applicationFeeRange: { min: 75, max: 125 },
    processingTimeWeeks: { min: 4, max: 6 },
    lastUpdated: new Date('2024-01-05'),
  },
  {
    ...
    abbreviation: 'MI',
    demandTag: 'at_risk',
    demandNotes: 'Detroit metro expansion planned',
    hasFPA: false,
    fpaApplicationRequired: false,
    requiresCollaborativeAgreement: true,
    collaborativeAgreementRequirements: {
      meetingCadence: 'monthly',
      chartReviewRequired: true,
      chartReviewFrequency: 'Monthly collaboration meetings',
      supervisoryActivities: ['Practice agreement', 'Delegation documentation', 'Chart review'],
    },
    requiresPrescriptiveAuthority: true,
    prescriptiveAuthorityNotes: 'Delegation of prescribing authority must be documented. Controlled substances require separate DEA.',
    notes: 'Practice agreement required with delegating physician. LARA (licensing board) processes applications. Part of NLC.',
    applicationFeeRange: { min: 127, max: 200 },
    processingTimeWeeks: { min: 6, max: 12 },
    lastUpdated: new Date('2024-01-08'),
  },
  {
    ...
    demandTag: 'stable',
    hasFPA: true,
    fpaEligibilityCriteria: ['2,080 hours of practice under collaborative agreement'],
    fpaApplicationRequired: true,
    requiresCollaborativeAgreement: true,
    collaborativeAgreementRequirements: {
      meetingCadence: 'quarterly',
    ...
    requiresPrescriptiveAuthority: false,
    notes: 'Independent practice after completing 2,080 hours. Initial collaborative agreement required. Part of NLC.',
    specialConsiderations: ['Hour requirement for independent practice'],
    applicationFeeRange: { min: 185, max: 250 },
    processingTimeWeeks: { min: 4, max: 8 },
    lastUpdated: new Date('2024-01-03'),
  },
  {
    ...
    abbreviation: 'MO',
    demandTag: 'watch',
    demandNotes: 'St. Louis and Kansas City markets',
    hasFPA: false,
    fpaApplicationRequired: false,
    requiresCollaborativeAgreement: true,
    collaborativeAgreementRequirements: {
      meetingCadence: 'monthly',
      chartReviewRequired: true,
      chartReviewFrequency: 'Monthly chart review required',
      supervisoryActivities: ['Collaborative practice arrangement', 'Chart review', 'Protocol review'],
    },
    requiresPrescriptiveAuthority: true,
    prescriptiveAuthorityNotes: 'Collaborative practice arrangement required. Geographic proximity rules apply.',
    notes: 'Collaborative practice arrangement (CPA) required. Physician must be within 75 miles. Part of NLC.',
    scopeLimitations: ['Geographic proximity requirement - 75 miles'],
    applicationFeeRange: { min: 75, max: 150 },
    processingTimeWeeks: { min: 4, max: 8 },
    lastUpdated: new Date('2024-01-10'),
  },
  {
    ...
    collaborativeAgreementRequirements: {
      meetingCadence: 'quarterly',
      chartReviewRequired: true,
      chartReviewFrequency: 'Periodic review as specified in protocol',
      supervisoryActivities: ['Collaborative practice protocol', 'Supervision documentation'],
    },
    requiresPrescriptiveAuthority: true,
    prescriptiveAuthorityNotes: 'Prescriptive authority included in collaborative practice protocol.',
    notes: 'Collaborative practice protocol required. Board of Nursing processes applications. Part of NLC.',
    applicationFeeRange: { min: 100, max: 150 },
    processingTimeWeeks: { min: 4, max: 8 },
    lastUpdated: new Date('2024-01-05'),
  },
  {
    ...
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state. Part of NLC. Rural practice considerations.',
    specialConsiderations: ['Rural and frontier area access', 'Telemedicine friendly'],
    applicationFeeRange: { min: 200, max: 275 },
    processingTimeWeeks: { min: 4, max: 6 },
    lastUpdated: new Date('2024-01-02'),
  },
  {
    ...
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state. Part of NLC. Board of Nursing regulates.',
    applicationFeeRange: { min: 130, max: 175 },
    processingTimeWeeks: { min: 4, max: 6 },
    lastUpdated: new Date('2024-01-08'),
  },
  {
    ...
    demandTag: 'stable',
    hasFPA: true,
    fpaEligibilityCriteria: ['2,000 hours of transition-to-practice collaboration'],
    fpaApplicationRequired: true,
    requiresCollaborativeAgreement: true,
    collaborativeAgreementRequirements: {
      meetingCadence: 'quarterly',
      chartReviewRequired: false,
      supervisoryActivities: ['Transition-to-practice agreement'],
    },
    requiresPrescriptiveAuthority: false,
    notes: 'Independent practice after 2,000 hours of transition-to-practice. Initial integrated practice agreement required. Part of NLC.',
    specialConsiderations: ['Transition period before full independence'],
    applicationFeeRange: { min: 123, max: 175 },
    processingTimeWeeks: { min: 4, max: 8 },
  ...
  },
  {
    ...
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state. Part of NLC. Efficient licensing process.',
    applicationFeeRange: { min: 120, max: 175 },
    processingTimeWeeks: { min: 4, max: 6 },
  ...
  },
  {
    ...
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state since 1993. Pioneer in NP independence. Part of NLC.',
    specialConsiderations: ['One of earliest FPA states'],
    applicationFeeRange: { min: 200, max: 260 },
    processingTimeWeeks: { min: 4, max: 8 },
    lastUpdated: new Date('2024-01-10'),
  },
  {
    ...
    abbreviation: 'NV',
    demandTag: 'watch',
    demandNotes: 'Las Vegas market growth monitoring',
    hasFPA: true,
    fpaEligibilityCriteria: ['2 years or 2,000 hours of practice'],
    fpaApplicationRequired: true,
    requiresCollaborativeAgreement: true,
    collaborativeAgreementRequirements: {
      meetingCadence: 'quarterly',
      chartReviewRequired: false,
      supervisoryActivities: ['Collaborative agreement during transition'],
    },
    requiresPrescriptiveAuthority: false,
    notes: 'Independent practice after 2 years or 2,000 hours. Initial collaborative agreement required. Part of NLC.',
    specialConsiderations: ['Transition period before full independence'],
    applicationFeeRange: { min: 200, max: 275 },
    processingTimeWeeks: { min: 6, max: 10 },
    lastUpdated: new Date('2024-01-08'),
  },
  {
    ...
    abbreviation: 'OR',
    demandTag: 'watch',
    demandNotes: 'Portland metro market evaluation',
    hasFPA: true,
    fpaEligibilityCriteria: ['No supervision requirements'],
    fpaApplicationRequired: false,
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state. Not part of NLC. Oregon State Board of Nursing regulates.',
    specialConsiderations: ['Not part of Nurse Licensure Compact'],
    applicationFeeRange: { min: 175, max: 240 },
    processingTimeWeeks: { min: 6, max: 10 },
    lastUpdated: new Date('2024-01-12'),
  },
  {
    ...
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state. Part of NLC. Compact state benefits.',
    applicationFeeRange: { min: 135, max: 190 },
    processingTimeWeeks: { min: 4, max: 6 },
    lastUpdated: new Date('2024-01-05'),
  },
  {
    ...
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state. Part of NLC. Office of Professional Regulation processes applications.',
    applicationFeeRange: { min: 150, max: 200 },
    processingTimeWeeks: { min: 4, max: 6 },
    lastUpdated: new Date('2024-01-03'),
  },
  {
    ...
    requiresCollaborativeAgreement: false,
    requiresPrescriptiveAuthority: false,
    notes: 'Full Practice Authority state. Part of NLC. Wyoming State Board of Nursing regulates.',
    applicationFeeRange: { min: 150, max: 200 },
    processingTimeWeeks: { min: 4, max: 6 },
    lastUpdated: new Date('2024-01-02'),
  },
